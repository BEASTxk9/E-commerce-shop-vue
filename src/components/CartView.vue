<template>
  ...
  <!-- cart stuff -->
  <button class="bg-transparent mx-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling"
    aria-controls="offcanvasScrolling" data-bs-placement="bottom" title="Cart."><i class="bi bi-cart4"></i></button>

  <div v-if="cart" class="offcanvas offcanvas-end" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
      ...
      <div v-for="(product, index) in cart" :key="index">
        <div class="container">
          ...
          <div class="row justify-content-center py-3">
            ...
            <!-- id -->
            <div id="index" class="col-sm-12 text-start py-1">
            ...
            <div class="col-sm-6 text-start">
              ...
              <p>"{{product.productData[0].Prod_name}}"</p>
              <hr>
              <label for="price">Price:</label>
              <p>"R{{product.productData[0].price}}"</p>
              <hr>
          ...
          <div class="col-sm-6 text-start">
            <button class="checkout w-100">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                ...
                <path style="fill:#363636"
                  d="M45,39H38a4,4,0,0,1,0-8h8a1,1,0,0,1,0,2H38a2,2,0,0,0,0,4h7a1,1,0,0,1,0,2Z"></path>
                <path style="fill:#363636"
