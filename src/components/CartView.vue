<template>
  ...
  >
    ...
    <div class="offcanvas-header">
      <h2 class="offcanvas-title text-cener" id="offcanvasScrollingLabel">
        Cart.
      </h2>
      <button
        type="button"
    ...
    <div class="offcanvas-body">
        ...
        <div class="container">
          <div class="row justify-content-center py-3">
            ...
            <div class="col-sm-6 py-1">
              <img
                :src="product.productData[0].img1"
      ...
      <div class="container">
        <div class="row">
          <!-- checkout -->
          <div class="col-sm-6 text-start">
            <button @click="deletecart" class="checkout w-100">
          ...
          <div class="col-sm-6 text-end">
            <button class="noselect w-100" @click="deletecart">
